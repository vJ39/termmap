...
// 市区町村境界・500mメッシュ人口)のディスク層。キー1件=1ファイルのJSONで保存し、種別ごとに
// 違うTTLで期限切れにする。
...
//
// 保存先: ~/.config/termmap/plot-cache/v1/{traffic,roads,camera,regulation,disaster,boundary,population}/{キー}.json
